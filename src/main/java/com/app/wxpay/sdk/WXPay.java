package com.app.wxpay.sdk;

import com.app.wxpay.sdk.WXPayConstants.SignType;
...
public class WXPay {
	...
	public WXPay(final WXPayConfig config, final String notifyUrl, final boolean useSandbox) {
		this.config = config;
	...
	public Map<String, String> processResponseXml(String xmlStr) throws Exception {
		...
		if (return_code.equals(WXPayConstants.FAIL)||result_code.equals(WXPayConstants.FAIL)) {
			return respData;
		} else if (return_code.equals(WXPayConstants.SUCCESS)&&result_code.equals(WXPayConstants.SUCCESS)) {
	...
	public Map<String, String> authCodeToOpenid(Map<String, String> reqData) throws Exception {
		return this
				.authCodeToOpenid(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
	}

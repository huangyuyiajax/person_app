...
public class WXPayConstants {
	...
	public static final String TRANSFERS_URL_SUFFIX = "/mmpaymkttransfers/promotion/transfers";//提现 接口文档https://pay.weixin.qq.com/wiki/doc/api/tools/mch_pay.php?chapter=14_2
